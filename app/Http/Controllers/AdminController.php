...
class AdminController extends Controller
{
  ...
  public function tampilDashboard(Request $request)
  {
    ...
    $format_uang = $baru = $diproses = $selesai = 
    $si = $mat = $total_si = $total_mat = $rentang = 
    $rentang_prodi = $data_bayar = $label_prodi = 
    $labels_bayar = $totals_bayar = $persen = $unit = 
    $result_mat = $data_prodi = null;
